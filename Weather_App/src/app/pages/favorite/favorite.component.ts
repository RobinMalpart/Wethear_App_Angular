...
export class FavoriteComponent implements OnInit {
  ...
  constructor(private favoriteService: FavoriteService, private weatherService: WeatherService, private jsonServerService: JsonServerService) {
  }
    ...
    this.favoriteService.getFavoritesByUserId(this.userId).subscribe(
      (favorites: any) => {
        favorites.forEach((favorite: any) => {
          this.jsonServerService.getLocationById(favorite.location_id).subscribe(
            (location: any) => {
